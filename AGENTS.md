...
- Follow the timing-control principles described in the QuMA literature. Do not copy CACTUS internals as an architectural constraint.
...
- Use bounded queues where hardware backpressure matters. Make overflow and underflow observable. Log structured trace events for instruction retirement, queue operations, feedback, and timed output.
...
- Do not claim a feature complete until the tests in `docs/engineering-and-testing.md` for that feature pass.
