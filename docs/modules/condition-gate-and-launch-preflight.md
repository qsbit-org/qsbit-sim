...
**Architecture position:** [Integrated contract, Section 3.13](../module-architecture.md#313-deterministic-condition-gate-and-launch-preflight). **Status:** proposed behavior; no implementation exists yet.
