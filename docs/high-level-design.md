...
2. **Phase 1 core:** versioned RV32I extension profile, assembler macros, command backpressure, concurrent output resources, readout and feedback, and a generic trace contract; the separate validation project supplies the CACTUS differential gate.
